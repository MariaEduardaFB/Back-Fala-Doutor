...
class MedicoController {
    ...
    async store(req, res) {
        try {
            ...
            const medicoAlreadyExists = await Medico.findByCrm(crm)
    ...
    async update(req, res) {
        try {
            ...
            const medicoAtualizado = await Medico.update(id, nome, crm, telefone)
    ...
    async destroy(req, res) {
        try {
            ...
            const deleted = await Medico.delete(id)
